...
processor = BatchSpanProcessor(OTLPMetricExporter(endpoint="localhost:9090"),)#sacar a consola
...
#metric
#metric_reader = PeriodicExportingMetricReader(ConsoleMetricExporter(),export_interval_millis=50) #sacar métrica a consola
metric_reader = PeriodicExportingMetricReader(OTLPMetricExporter(endpoint="localhost:9090"),export_interval_millis=50) #sacar métrica a OTLP
